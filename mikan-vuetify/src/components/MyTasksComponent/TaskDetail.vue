...
async function save() {
  ...
  ? `${new Date(localTask.value.dueDate).getFullYear()}-${String(new Date(localTask.value.dueDate).getMonth() + 1).padStart(2, '0')}-${String(new Date(localTask.value.dueDate).getDate()).padStart(2, '0')}`
  : null,
